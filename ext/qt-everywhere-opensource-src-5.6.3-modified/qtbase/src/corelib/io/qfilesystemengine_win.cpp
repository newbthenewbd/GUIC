...
** $QT_END_LICENSE$
**
** Modified 2024/11/07 by Czcibor Bohusz-Dobosz
** in accordance with https://codereview.qt-project.org/c/qt/qtbase/+/365167
** (accessed 2024/11/07; thanks!)
**
****************************************************************************/
...
#  if (defined(Q_CC_MINGW) || (defined(Q_CC_MSVC) && (_MSC_VER < 1700 || WINVER <= 0x0601))) && _WIN32_WINNT < _WIN32_WINNT_WIN8 //  Windows 8 onwards
...
#  endif // if (defined (Q_CC_MINGW) || (defined(Q_CC_MSVC) && (_MSC_VER < 1700 || WINVER <= 0x0601))) && _WIN32_WINNT < _WIN32_WINNT_WIN8
